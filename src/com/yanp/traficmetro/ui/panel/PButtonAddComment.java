 ...
 */
public class PButtonAddComment extends Button implements IPanel {
	...
	public PButtonAddComment(Context context, int widthScreen, int heightScreen, AnimationManager animationManager) {
		super(context);
