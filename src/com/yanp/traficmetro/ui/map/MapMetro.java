...
import com.yanp.traficmetro.core.map.Line;
import com.yanp.traficmetro.core.map.Station;
import com.yanp.traficmetro.ui.panel.PBackground;
import com.yanp.traficmetro.ui.panel.PButtonAddComment;
import com.yanp.traficmetro.ui.panel.PInfoStations;
import com.yanp.traficmetro.ui.panel.PListComments;
...
public class MapMetro extends RelativeLayout{
    ...
    private PButtonAddComment buttonAddComment;
    private PBackground greyPanel;
    //private PanelInfoStations_ex panelInfoStations;
    private PInfoStations panelInfoStations;
    private PListComments panelListComments;
	...
	public MapMetro(Context context, int statusBarHeight, AnimationManager animationManager){
		...
		this.greyPanel=new PBackground(getContext(), this.animationManager, this);
		//this.panelInfoStations=new PanelInfoStations_ex(getContext(), this.widthScreen, this.heightScreen, this.animationManager);
        this.panelInfoStations=new PInfoStations(getContext(), this.widthScreen, this.heightScreen, this.animationManager);
	    this.buttonAddComment = new PButtonAddComment(getContext(), this.widthScreen, this.heightScreen, this.animationManager);
		this.panelListComments = new PListComments(getContext(), this.widthScreen, this.heightScreen, this.animationManager);
	...
	public void addInformationsPanel(String stationName, String lineName){
		...
		addGreyPanel();
		addListViewComments(stationName);
		addTextViewInfoStation(stationName,lineName);
		addButtonAddComment(stationName);
	 ...
	 */
	private void addListViewComments(String idStation){
	 ...
	 */
	private void addButtonAddComment(String idStation){
