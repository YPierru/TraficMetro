...
public class Struct_AllComments {
    ...
    private HashMap<String,ArrayList<TL_Comment>> allCom = new HashMap<String,ArrayList<TL_Comment>>();
    ...
    public ArrayList<TL_Comment> getListTLCForStation(String id){
        return this.allCom.get(id);
    }

    public int getLastColorById(String id){
