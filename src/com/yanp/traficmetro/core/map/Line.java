package com.yanp.traficmetro.core.map;
...
import com.yanp.traficmetro.ui.map.LineView;
...
public class Line {
	...
	public Line(Context ct, int r, int g, int b, String name, MapMetro mapmetro){
		this.context=ct;
		this.name=name;
